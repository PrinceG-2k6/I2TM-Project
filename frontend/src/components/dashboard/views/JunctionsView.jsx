          ...
          <div data-subsection="Cameras & Signal Telemetry" className="grid grid-cols-[repeat(auto-fit,minmax(340px,1fr))] gap-6">
            <div className="bg-(--color-4) rounded-sm p-4 h-fit">
              <div className="flex items-center justify-between mb-3">
                ...
                <Badge variant="healthy" size="sm">4 CCTV Wedges</Badge>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {Object.entries(approaches).map(([dir, app]) => {
                ...
                return (
                  <div
                    key={dir}
                    className="bg-(--color-5) rounded-sm p-2.5 text-center"
                  >
                    ...
                    <div className="text-xs">
                      ...
                      <span className="ml-0.5 text-(--color-2)">
                        ({app.greenSec}s)
                      </span>
                    </div>
                  </div>
            ...
            <div className="space-y-2">
              {Object.entries(approaches).map(([dir, data]) => {
                ...
                return (
                  <div
                    key={dir}
                    className="bg-(--color-5) rounded-sm py-2.5 px-3"
                  >
